kommuner = 0101 2111 0941 1850 2011 5043 0213 0529 0904 1253 5001 0301 2020 1002 0710 1902 2030 2012 1201 1103 0106 0501 0806

all:
	python ssr2.py --output html/data/ --kommune ALL --include_zz --parallel 8
	$(MAKE) webpage
	$(MAKE) sync

debug:
	python ssr2.py --output html/data/ --kommune $(kommuner) --include_zz
	$(MAKE) webpage
	$(MAKE) sync
...
sync:
	s3cmd sync -H --delete-removed --acl-public --storage-class=REDUCED_REDUNDANCY --exclude=*DS_Store html/ s3://ssr2-to-osm/
